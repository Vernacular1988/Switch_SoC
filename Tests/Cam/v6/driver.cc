...
static trans command_list[NUMCOM] = {
  ...
  STAG,		0,	0,	0,	0,	// set all tags
  CTAG,		0,	0,	0,	0,	// clear all tags
  ITAG,		0,	0,	0,	0,	// complement all tags
  ...
  COMP,		0,	0x13, 	0,	0,	// compare for 0x13
  HAMM,		0xF0,	0x03,	0,	0,	// haming distance for 000000*3
  WTA,		0,	0,	0,	0,	// winner take all
  AREAD,	0,	0,	0,	0,	// read the winner
  COMP,		0,	0x13, 	0,	0,	// compare for 0x13
  HAMM,		0xF0,	0x03,	0,	0,	// haming distance for 000000*3
  STAG,		0,	0,	0,	0,	// set all tags
  READNB,	0,	0,	0,	0,	// next best match
  READNB,	0,	0,	0,	0,	// next best match
  READNB,	0,	0,	0,	0,	// next best match
  READNB,	0,	0,	0,	0,	// next best match
  COMP,		0,	0x17, 	0,	0,	// compare for 0x17
  COMP,		0xF,	0x20, 	0,	0, 	// compare for 0x2* (finds 27)
