...
int sc_main(int argn,char* argc[])
{
	...
	sadc adc1("adc1");
	  ...
	  sca_util::sca_trace_file* 
	    sctf = sca_util::sca_create_vcd_trace_file( "sctf" );

	  sca_util::sca_trace(sctf, s1 ,"s1" );	
	  sca_util::sca_trace(sctf,s2, "s2");
	  sca_util::sca_trace(sctf,s3, "s3");
	  sca_util::sca_trace(sctf,s4, "s4");
